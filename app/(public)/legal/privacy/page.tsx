        ...
        <main className="privacy-main">
          <section id="introduction" className="privacy-section">
            ...
            <p>
              ...
              menggunakan layanan kami. Kami berkomitmen untuk menjaga
          ...
          <section id="rights" className="privacy-section">
            ...
            <ul className="privacy-list">
              ...
              <li>
                Hak untuk memperbarui atau memperbaiki informasi yang tidak
                akurat atau tidak lengkap.
              </li>
              <li>
                Hak untuk meminta penghapusan data tertentu, sesuai dengan
          ...
          <section
            id="contact"
            className="privacy-section privacy-section-highlight"
          >
            <h2 className="privacy-section-title">
              6. Kontak &amp; Informasi Tambahan
            </h2>
            <p>
            ...
            <p>
              ...
              menyesuaikan dengan perkembangan regulasi atau kebutuhan
              operasional. Setiap perubahan penting akan kami informasikan
              melalui situs FTI News.
            </p>
          </section>
