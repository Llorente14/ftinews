    ...
    <div className="terms-page">
      <header className="terms-hero">
        <div className="terms-hero-inner">
          ...
          <nav className="terms-quicklinks" aria-label="Navigasi bagian dokumen">
      ...
      <main className="terms-main">
        ...
        <section id="use-of-service" className="terms-section">
          ...
          <div className="terms-grid">
            <div className="terms-card">
              ...
              <p>
                Untuk mengakses fitur tertentu (seperti komentar, bookmark, atau
                pengelolaan artikel), Anda mungkin perlu membuat akun. Anda
                bertanggung jawab penuh atas kerahasiaan kredensial akun serta
                seluruh aktivitas yang terjadi melalui akun tersebut.
              </p>
            </div>
            <div className="terms-card">
              <h3>2.2 Perilaku yang Dilarang</h3>
              <ul className="terms-list">
                <li>Mengunggah atau menyebarkan konten yang melanggar hukum.</li>
                <li>
                  Melakukan spam, phishing, atau aktivitas yang mengganggu
                  layanan.
                </li>
                <li>
                  Mencoba mengakses sistem tanpa izin, termasuk upaya peretasan
                  atau eksploitasi.
                </li>
              </ul>
            </div>
        ...
        <section id="content-policy" className="terms-section">
          <h2 className="terms-section-title">3. Kebijakan Konten & Hak Cipta</h2>
          <p>
            Seluruh konten yang diterbitkan di FTI News (termasuk teks, gambar,
            ilustrasi, dan materi multimedia lainnya) dilindungi oleh hak cipta
            dan/atau hak kekayaan intelektual lainnya.
          </p>
          <ul className="terms-list">
            <li>
        ...
        <section id="privacy" className="terms-section">
          ...
          <p>
            ...
            bagaimana kami mengumpulkan, menggunakan, dan menyimpan data pribadi
        ...
        <section id="limitation" className="terms-section">
          ...
          <p>
            ...
            namun tidak dapat menjamin bahwa seluruh konten bebas dari kesalahan
            atau kelalaian. Penggunaan informasi dari situs ini sepenuhnya
            menjadi tanggung jawab pengguna.
          </p>
          <p>
            Dalam batas maksimal yang diizinkan oleh hukum, FTI News tidak
            bertanggung jawab atas kerugian langsung maupun tidak langsung yang
            timbul dari penggunaan atau ketidakmampuan menggunakan layanan
            kami.
          </p>
        </section>

        <section id="contact" className="terms-section terms-section-highlight">
          <h2 className="terms-section-title">6. Kontak & Perubahan Ketentuan</h2>
          <p>
            Kami dapat memperbarui Syarat dan Ketentuan ini dari waktu ke waktu.
            Perubahan penting akan kami umumkan melalui situs FTI News.
          </p>
          <p>
