      ...
      <main className={styles.main}>
        ...
        <section className={styles.pageHeader}>
          ...
          <p className={styles.pageSubtitle}>
            Punya berita menarik, pertanyaan, atau ingin beriklan? Tim FTI News
            siap mendengar dari Anda.
          </p>
              ...
              <div className={styles.contactInfoList}>
                ...
                <div className={styles.contactItem}>
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:redaksi@ftinews.com"
                      className={styles.infoLink}
                    >
                      redaksi@ftinews.com
                    </a>
                    <a
                      href="mailto:iklan@ftinews.com"
                      className={styles.infoLink}
                    >
                      iklan@ftinews.com
                    </a>
                ...
                <div className={styles.contactItem}>
                  ...
                  <div>
                    ...
                    <a href="tel:+62215551234" className={styles.infoLink}>
                      (021) 555-1234
                    </a>
                  </div>
                </div>
